import { useGetAllMoviesQuery, useGetRandomMoviesQuery } from "../../redux/api/movie";
import { useFetchGenreQuery } from "../../redux/api/genre";
import { useGetNewMoviesQuery, useGetTopMoviesQuery } from '../../redux/api/movie.js';
import MovieCard from "./MovieCard.jsx";
import { useEffect } from "react";
import { useSelector, useDispatch } from "react-redux";
import banner from '../../assets/banner.jpg';
import { setMovieYears, setFilteredMovies, setUniqueYears, setMoviesFilter } from "../../redux/features/movies/moviesSlice.js";

const AllMovies = () => {
  const dispatch = useDispatch();
  const { data } = useGetAllMoviesQuery();
  const { data: genre } = useFetchGenreQuery();
