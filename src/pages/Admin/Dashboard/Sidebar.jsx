...
export default function Sidebar() {
  return (
    <div className="-translate-y-10 flex h-screen fixed mt-10 border-r-2 border-[#242424]">
      <aside className="text-white w-[13.5rem] flex-shrink-0">
        <ul className="py-4">
            <li className="text-lg bg-gradient-to-b from-green-500 to-lime-400 rounded-full -translate-x-6">
                <Link to={'/admin/movies/dashboard'} className="block p-2 ml-20 mb-10">Dasbhoard</Link>
            </li>
            ...
            <li className="text-lg hover:bg-gradient-to-b from-green-500 to-lime-400 rounded-full -translate-x-6">
                <Link to={'/admin/moviesList'} className="block p-2 ml-20 mb-10">Update Movies</Link>
            </li>
            <li className="text-lg hover:bg-gradient-to-b from-green-500 to-lime-400 rounded-full -translate-x-6">
